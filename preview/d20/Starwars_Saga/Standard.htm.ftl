...
<!-- START Initiative Table -->
   <table summary="Initiative Table">
    <tr>
     ...
     <td align="center" class="border10"><b>${pcstring('SKILLSIT.INITIATIVE.TOTAL')}</b></td>
     <td align="center" class="font7"><b>=</b></td>
     <td align="center" class="border10"><b>${pcstring('STAT.1.MOD')}</b></td>
     <td align="center" class="font7"><b>+</b></td>
     <td align="center" class="border10"><b>${pcstring('SKILLSIT.INITIATIVE.MISC')}</b></td>
	 <td align="center" class="font7"><b>+</b></td>
	 <td align="center" class="border10"><b>${pcstring('VAR.INITIATIVEFEATBONUS.INTVAL')}</b></td>
	 <td align="center" class="font7"><b>+</b></td>
	 <td align="center" class="border10"><b>${pcvar('VAR.HEROICBOOST.INTVAL')}</b></td>
    ...
    <tr>
     ...
     <td align="center"></td>
     <td align="center" width="25" class="font6">INITIATIVE PROFICIENCY</td>
	 <td align="center"></td>
     <td align="center" width="25" class="font6">INITIATIVE FEAT BONUS</td>
	<td align="center"></td>
     <td align="center" width="25" class="font6">LEVEL BONUS</td>
    </tr>
   </table>
...
<!-- START Saving Throws Table -->
   <table width="100%" summary="Saving Throws">
    <tr>
     <td align="center" class="font6">SAVE DCs</td>
     ...
     <td align="center"></td>
     <td align="center" width="25" class="font6">ARMOR</td>
     <td align="center"></td>
     <td align="center" width="25" class="font6">ARMOR ABILITY</td>
     <td align="center"></td>
...
<#else>
	 ...
	 <#if (pcstring("CHECK.${checks}.NAME") = "Reflex")>
     <td align="center" class="border10"><b>${pcvar('CHECK.${checks}.TOTAL + VAR.REFLEXARMOR')}</b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Will")>
     <td align="center" class="border10"><b>${pcvar('CHECK.${checks}.TOTAL + VAR.WILLARMOR')}</b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Fortitude")>
     <td align="center" class="border10"><b>${pcvar('CHECK.${checks}.TOTAL + VAR.FORTITUDEARMOR')}</b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Damage Threshold")>
     <td align="center" class="border10"><b>${pcvar('CHECK.${checks}.TOTAL + VAR.DTARMOR')}</b></td>
	 </#if>
     <td align="center" class="font7"><b>=</b></td>
     ...
     <td align="center" class="font7"><b>+</b></td>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Reflex")>
	 <td align="center" class="border10"><b>+${pcstring('VAR.REFLEXARMOR.INTVAL')}<br /></b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Will")>
	 <td align="center" class="border10"><b>+${pcstring('VAR.WILLARMOR.INTVAL')}<br /></b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Fortitude")>
	 <td align="center" class="border10"><b>+${pcstring('VAR.FORTITUDEARMOR.INTVAL')}<br /></b></td>
	 </#if>
	 <#if (pcstring("CHECK.${checks}.NAME") = "Damage Threshold")>
	 <td align="center" class="border10"><b>+${pcstring('VAR.DTARMOR.INTVAL')}<br /></b></td>
	 </#if>
	 <td align="center" class="font7"><b>+</b></td>
...
<@loop from=0 to=3 ; range , range_has_next>
    ...
    <tr>
     <td align="left" bgcolor="black" class="border"><font style="font-size:8pt" color="white"><b>&nbsp;Bonus</b></font></td>
<#assign count = 0>
<@loop from=0 to=3 ; range1 , range1_has_next>
     <td align="center" bgcolor="white" class="border7"><b>${pcstring('WEAPON.${weap}.RANGELIST.${range1}.TOTALHIT')}<br /></b></td>
    ...
    <tr>
     <td align="left" bgcolor="black" class="border"><font style="font-size:8pt" color="white"><b>&nbsp;Dam</b></font></td>
<@loop from=0 to=3 ; range2 , range2_has_next>
     <td align="center" bgcolor="white" class="border7"><b>${pcstring('WEAPON.${weap}.RANGELIST.${range2}.DAMAGE')}</b></td>
</@loop>
    </tr>
    <tr>
...
<!-- START Weight Table -->
    <table width="100%" cellspacing="0" cellpadding="3" summary="Weight Allowance Table">
     ...
     <tr>
      ...
      <td valign="top" class="border8" align="right"><b>Overweight</b></td>
...
<!-- START Talents Table -->
<#if (pcvar('countdistinct("ABILITIES","CATEGORY=Talent","TYPE=Talent","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY")') > 0)>
   <table width="100%" cellspacing="0" cellpadding="2" summary="Feat Table">
    <tr>
     <th bgcolor="black" align="center" colspan="2"><font color="white" style="font-size: small"><b>Talents</b></font></th>
    </tr>
<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Talent","TYPE=Talent","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY")-1') ; Talent , Talent_has_next>
<#if (Talent % 2 = 0)><tr bgcolor="#DDDDDD"><#else><tr bgcolor="white"></#if>
     <td valign="top" width="70%" class="font8"><b>
<#assign typeOfAbility = pcstring("ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent.TYPE")?lower_case />
<#if (pcstring("ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent.HASASPECT.Name") = "Y")>
${pcstring('ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent.ASPECT.Name')}
<@typeOfAbilitySuffix typeOfAbility=typeOfAbility />
<#else>
${pcstring('ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent')}
<@typeOfAbilitySuffix typeOfAbility=typeOfAbility />
</#if>
</b>
</td>
<td class="font8" valign="top"	width="30%" align="right">[${pcstring('ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent.SOURCE')}]</td>
<tr>
<#if (Talent % 2 = 0)><tr bgcolor="#DDDDDD"><#else><tr bgcolor="white"></#if>
<td class="font8" valign="top"	align="indent" colspan="2">&#160;&#160;&#160;&#160;
${pcstring('ABILITYALL.Talent.VISIBLE.${Talent}.TYPE=Talent.DESC')}</td>
    </tr>
</@loop>
   </table>
</#if>
